<template>
  <div class="add-employess container">
    <Breadcrumb :items="['客服管理', { name: '客服工单', router: () => $router.replace({ name: 'ServiceWorkOrderList' }) }, '详情']" />
...
export default defineComponent({
  ...
  setup() {
    ...
    const addWorkOrder = () => {
      router.push({ name: "CreateServiceWorkOrderAssociatedWorkOrder", params: { ticketId } });
    };
    const reload = () => {
