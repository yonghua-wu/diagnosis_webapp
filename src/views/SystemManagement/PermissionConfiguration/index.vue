<template>
  <div class="container permission-view">
...
export default defineComponent({
  ...
  setup() {
    ...
    const loadData = (query: any) => {
      return Permission.page(query.current, query.pageSize, {
    ...
    const refRDVue = ref();
    const clickEdit = (record: PermissionModel) => {
      router.push({ name: "PermissionConfigurationDetail", params: { id: record.id, model: "Edit" } });
    };
    const clickView = (record: PermissionModel) => {
      router.push({ name: "PermissionConfigurationDetail", params: { id: record.id, model: "View" } });
    };
    const clickCreate = () => {
      router.push({ name: "PermissionConfigurationDetail", params: { model: "Add" } });
    };
    ...
    const clickDelete = (record: PermissionModel) => {
      doDelele([record.id]);
    };
